  ...
  <div class="tab-content">
	...
	<div id="addTransaction">
			...
			<div class="panel-body"><strong>Add Expense</strong></div>
				...
				<form role="form" name="expenseform" method="post" action="/expensetracker/rest/user/expense">
			<div class="form-group">
	...
	<ul class="pagination pagination-md" id="pagination">
		...
		<ul>
			<#list expensedetails as ed>
				<li>${ed.accountNumber}-------${ed.date}--------${ed.description}---------${ed.amount}-------${ed.category}</li>
			</#list>
		</ul>
